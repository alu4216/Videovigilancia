...
public:
    ...
    void setupUi(QMainWindow *ViewerWindow)
    {
        ...
        actionComenzar_a_enviar->setObjectName(QStringLiteral("actionComenzar_a_enviar"));
    ...
    {
        ViewerWindow->setWindowTitle(QApplication::translate("ViewerWindow", " Ventana Cliente", 0));
        ...
        actionComenzar_a_enviar->setText(QApplication::translate("ViewerWindow", "Comenzar a enviar", 0));
