...
#include "../visor-servidor/acerca.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Acerca_t, stringdata) + ofs \
...
const QMetaObject Acerca::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_Acerca.data,
      qt_meta_data_Acerca,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Acerca.stringdata))
